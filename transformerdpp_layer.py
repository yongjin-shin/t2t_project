...
from fairseq.models.multihead_attention_DPP import MultiheadAttention_Dpp


class TransformerEncoderLayerDpp(nn.Module):
    """Encoder layer block.
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def __init__(self, args):
        ...
        self.self_attn = MultiheadAttention_Dpp(
    ...
    def forward(self, x, encoder_padding_mask, attn_mask=None):
        ...
        x, _, dpp_loss = self.self_attn(query=x, key=x, value=x, key_padding_mask=encoder_padding_mask)
...
class TransformerDecoderLayerDpp(nn.Module):
    """Decoder layer block.
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def __init__(self, args, no_encoder_attn=False, add_bias_kv=False, add_zero_attn=False):
        ...
        if no_encoder_attn:
            ...
            self.encoder_attn = MultiheadAttention_Dpp(
                self.embed_dim,
    ...
    def forward(
        ...
        x, attn, dpp_loss = self.self_attn(
            query=x,
            key=y,
            value=y,
        ...
        if self.encoder_attn is not None:
            ...
            x, attn, dpp_loss_E = self.encoder_attn(
                query=x,
                key=encoder_out,
                value=encoder_out,
            ...
            dpp_loss = (dpp_loss + dpp_loss_E) / 2
